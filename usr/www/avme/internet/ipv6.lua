...
require"menu"
if not menu.check_page("internet", "/internet/ipv6.lua") then
require"http"
...
elseif (szMode == "ipv6_automatic") then
...
if ((ipv6_mode:get_value() == "ipv6_automatic" ) and (ipv6_hidden_ipv4:get_value() ~= "1" )) then
ipv6_mode:save_value( saveset)
...
?>
var maxMTU = 1500;
if (jxl.getChecked(<?lua box.out(ipv6_use_fixed_mtu:get_var_name_js()) ?>) && jxl.getValue(<?lua box.out(ipv6_mtu_override:get_var_name_js()) ?>) > maxMTU ) {
...
box.out( elem._radio( ipv6_mode:get_var_name(),ipv6_mode:get_var_name_js()..[[_0]],"ipv6_automatic",(ipv6_mode:get_value() == "ipv6_automatic"), [[onclick="OnChange_ConnectionMode('ipv6_automatic')"]] ))
box.out( [[&nbsp;]])
...
box.out( [[&nbsp;]])
box.out( elem._label( ipv6_ipv4_mode:get_var_name_js()..[[_Static]], "Label"..ipv6_ipv4_mode:get_var_name_js()..[[_Static]], [[{?683:677?}]],"","labelWidth"))
box.out( [[&nbsp;]])
...
box.out( [[&nbsp;]])
box.out( elem._label( ipv6_ipv4_mode:get_var_name_js()..[[_Static]], "Label"..ipv6_ipv4_mode:get_var_name_js()..[[_Static_FQDN]], [[{?683:301?}]],"","labelWidth"))
box.out( [[&nbsp;]])
...
?>
<p class="formular">{?683:545?}</p>
</div>
<div id="uiShow_IPv6Settings_Details" style="">
<p><b>{?683:711?}</b></p>
<div class="formular" id="uiShow_IPv6Settings_Native" style="">
<?lua
...
box.out( [[<p class="formular"> <!-- ipv6_static - Prefix/Prefix-length -->]])
box.out( elem._label( ipv6_static_prefix:get_var_name_js(), "Label"..ipv6_static_prefix:get_var_name_js(), [[{?683:141?}]]))
...
box.out( [[</p>]])
box.out( [[<p class="formular"> <!-- ipv6 static Wan-Prefix auto -->]])
box.out( elem._label( ipv6_wan_use_first_prefix:get_var_name_js()..[[_1]], "Label"..ipv6_wan_use_first_prefix:get_var_name_js()..[[_1]], [[{?683:3475?}]]))
...
box.out( [[&nbsp;]])
box.out( elem._label( ipv6_wan_use_first_prefix:get_var_name_js()..[[_1]], [[Label]]..ipv6_wan_use_first_prefix:get_var_name_js()..[[_2]], [[{?683:510?}]]))
box.out( [[</p>]])
box.out( [[<p class="formular"> <!-- ipv6 static Wan-Prefix manuell -->]])
box.out( elem._label( ipv6_wan_use_first_prefix:get_var_name_js()..[[_0]], "Label"..ipv6_wan_use_first_prefix:get_var_name_js()..[[_3]], [[]]))
...
box.out( [[&nbsp;]])
box.out( elem._label( ipv6_wan_use_first_prefix:get_var_name_js()..[[_0]], [[Label]]..ipv6_wan_use_first_prefix:get_var_name_js()..[[_4]], [[{?683:105?}]]))
...
box.out( [[</p>]])
box.out( [[<p class="formular"> <!-- ipv6 static Wan-interface-ID auto -->]])
box.out( elem._label( ipv6_wan_ifid_automatic:get_var_name_js()..[[_1]], "Label"..ipv6_wan_ifid_automatic:get_var_name_js()..[[_1]], [[{?683:942?}]]))
...
box.out( [[&nbsp;]])
box.out( elem._label( ipv6_wan_ifid_automatic:get_var_name_js()..[[_1]], [[Label]]..ipv6_wan_ifid_automatic:get_var_name_js()..[[_2]], [[{?683:689?}]]))
box.out( [[</p>]])
box.out( [[<p class="formular"> <!-- ipv6 static Wan-interface-ID Manuell -->]])
box.out( elem._label( ipv6_wan_ifid_automatic:get_var_name_js()..[[_0]], "Label"..ipv6_wan_ifid_automatic:get_var_name_js()..[[_3]], [[]]))
...
box.out( [[&nbsp;]])
box.out( elem._label( ipv6_wan_ifid_automatic:get_var_name_js()..[[_0]], [[Label]]..ipv6_wan_ifid_automatic:get_var_name_js()..[[_4]], [[{?683:1101?}]]))
...
<div id="uiShow_IPv6Settings_Tunnel" style="">
<p>{?683:543?}</p>
<div class="formular">
<div class="wide">
<?lua
...
box.out( [[<div class="formular">]])
box.out( [[<div class="formular">]])
box.out( elem._label( "ui_6rdEndPoint_0", "Label".."ui_6rdEndPoint_0", [[{?683:578?}:]]))
...
box.out( [[</div>]])
box.out( [[<div class="formular">]])
box.out( elem._label( ipv6_6rd_prefix:get_var_name_js(), "Label"..ipv6_6rd_prefix:get_var_name_js(), [[{?683:123?}]]))
...
box.out( elem._label( "ui_6to4EndPoint_0", "Label".."ui_6to4EndPoint_0", [[{?683:739?}:]]))
...
box.out( [[</p>]])
box.out( [[<p class="formular"><!--6to4static Tunnel Endpunkt-->]])
box.out( elem._label( ipv6_6to4static_prefix:get_var_name_js(), "Label"..ipv6_6to4static_prefix:get_var_name_js(), [[{?683:526?}]]))
...
box.out( [[&nbsp;]])
box.out( elem._label( ipv6_use_fixed_mtu:get_var_name_js(), "Label"..ipv6_use_fixed_mtu:get_var_name_js(), [[{?683:7036?}]]))
box.out( [[&nbsp;]])
